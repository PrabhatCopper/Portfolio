 ...
 * 		[5] Lettering
 * 		[6] Detect Browser
 * 			by: Prabhat Kumar [Date: 06:44 AM 4/May/2014]
 */
/*==========================================================================================*/
/*									[Cloud Flare CDN]										*/
/*==========================================================================================*/
$(function(){
	$.getScript("http://cdnjs.cloudflare.com/ajax/libs/gsap/latest/easing/EasePack.min.js",function(){
		console.log("EasePack is loaded, Now.");
	});
});
/*==========================================================================================*/
...
/*==========================================================================================*/
(function($){var x = "#6EA811";var y = "#FFFFFF";$.fn.copper = function(){this.css({"color":x,"background-color":y});return this;}})(jQuery);
/*==========================================================================================*/
...
/*==========================================================================================*/
$(function(){
	/*[To initialize SuperScrollorama]*/
	...
	/*[Resource Links]*/
	var baseURL = "http://staging.coppermobile.com/portfolio";
	var baseCSS = "css/";
	var baseJS = "/scripts/";
	/* to get scripts according to available width */
	$(window).bind("load",function(event){
		//event.stopImmediatePropagation();
		/* to get current window width */
		var $width = $(window).width();
		/*[for Desktop Parallax]*/
		if($width >= 911){
			if(bowser.firefox || bowser.webkit){
				$.getScript(baseURL + baseJS + "firefox.app.min.js",function(){
					doDesktop();
					console.log("Desktop is working, Now!");
				});
			} else if(bowser.msie && bowser.version <= 8){
				var msg = "Unsupported Browser; Please upgrade or use different one to enjoy Parallax!";
				var get = "<br><a href='http://browsehappy.com/' title='Latest versions of the major browsers!'>http://browsehappy.com/</a>";
				var div = $("div.ie").css({"color":"#F00","font-size":"79%","margin":"0 auto","text-align":"center"}).fadeOut(8800);
					div.append(msg + get);
			}
		}
		/*[for Mobile Parallax]*/
		//if($width < 480){
			if(bowser.mobile){
				$.getScript(baseURL + baseJS + "mobileApp.min.js",function(){
					// doMobile();
					alert("Mobile is working, Now!");
				});
			}
		//}
	});
	...
	/* some design fix(s): for The Need Section */
	if(bowser.webkit){
		$(".the-need-text-wrap").css({"margin":"24px 135px 38px 135px"});
	}
	if(bowser.firefox){
		$(".the-need-text-wrap").css({"margin":"14px 135px 38px 135px"});
	}	
});
/* Date: 6:44 PM 5/6/2014 */
